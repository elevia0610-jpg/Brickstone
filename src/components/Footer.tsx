      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <div className="flex flex-col gap-3 text-sm opacity-70">
            ...
            <a href="mailto:info@brickstonerealestate.in" className="flex items-center gap-2 hover:opacity-100 transition-opacity">
              <Mail className="w-4 h-4" /> info@brickstonerealestate.in
            </a>
